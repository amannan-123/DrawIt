...
Partial Class AnglesDialog
    ...
    Private Sub InitializeComponent()
        ...
        Me.T_Sweep = New Controls.MyTrackBar()
        Me.T_Start = New Controls.MyTrackBar()
        Me.SuspendLayout()
        '
        'Label2
        '
    ...
    Friend WithEvents T_Sweep As Controls.MyTrackBar
    Friend WithEvents T_Start As Controls.MyTrackBar
End Class
