...
Partial Class PointsEditor
    ...
    Private Sub InitializeComponent()
        ...
        Me.PEditor = New MyControls.ShapePointsEditor()
        Me.TB_Tension = New MyControls.MyTrackBar()
    ...
    Friend WithEvents PEditor As MyControls.ShapePointsEditor
    Friend WithEvents cbPreview As CheckBox
    Friend WithEvents TB_Tension As MyControls.MyTrackBar
